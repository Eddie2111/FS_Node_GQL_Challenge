...
export default function Product() {
  ...
  if (data) {
    ...
    return (
      <>
      <Text className="mx-20 mb-4 w-[180px] text-xl hover:text-blue-500 underline duration-300" onClick={()=>navigate("/home")}> ← Back to home </Text>
      <div className="flex justify-center items-center p-4">
        <Card shadow="sm" padding="lg" className="w-full max-w-md">
          ...
          <div className="flex flex-row items-center mt-4">
            ...
            <Badge color="pink" variant="light" className="mx-2">
